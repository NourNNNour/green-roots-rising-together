        ...
        <div className="mt-12 pt-6 border-t border-gray-200">
          <div className="flex flex-wrap justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="font-semibold text-gray-700 mb-2">Share this article:</p>
            ...
            <div>
              <p className="font-semibold text-gray-700 mb-2">Related Topics:</p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Environment</span>
                <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Trees</span>
                <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-sm">Conservation</span>
              </div>
            </div>
          </div>
        </div>
