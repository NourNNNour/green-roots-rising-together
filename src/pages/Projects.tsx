      ...
      <div className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-green-700">Our Projects</h1>
            <p className="text-lg max-w-3xl mx-auto text-gray-700">
              Explore our active environmental initiatives and discover how we're making a difference in communities across the region.
            </p>
          </div>
          
          <div className="mb-12">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl md:text-3xl font-semibold text-green-600">Active Projects</h2>
          ...
          <div className="bg-green-50 rounded-lg p-8 md:p-12 text-center">
            ...
            <p className="text-lg mb-6 max-w-2xl mx-auto text-gray-700">
              We're always looking for new projects and collaboration opportunities. If you have an idea for an environmental initiative in your community, we'd love to hear from you!
            </p>
            <Link to="/contact">
